...
@click.argument('source', type=click.Path(path_type=Path, exists=True, dir_okay=False), nargs=-1)
    ...
    if USE_MULITPROCESSING:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            for future in concurrent.futures.as_completed(futures):
                ...
                print(f'{compressed_image.name:<{longest}}  {humanize(original_size):>6} -> {humanize(optimized_size):>6}')
